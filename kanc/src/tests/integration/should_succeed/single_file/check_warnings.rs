...
fn type_assertion_goal_lhs() {
    ...
    let src =
        include_str!("../../../sample_code/should_succeed/single_file/should_succeed_with_warnings/check/type_assertion_goal_lhs.k");
...
fn type_of_type0() {
    use TypeCheckWarningSummary::*;
    let src = include_str!(
        "../../../sample_code/should_succeed/single_file/should_succeed_with_warnings/check/type_of_type0.k"
    );
...
fn type_assertion_type_check_failure() {
    use TypeCheckWarningSummary::*;
    let src = include_str!(
        "../../../sample_code/should_succeed/single_file/should_succeed_with_warnings/check/type_assertion_type_check_failure.k"
    );
    let expected_warnings = vec![
...
fn mismatched_types() {
    use TypeCheckWarningSummary::*;
    let src = include_str!(
        "../../../sample_code/should_succeed/single_file/should_succeed_with_warnings/check/mismatched_types.k"
    );
    let expected_warnings = vec![
...
fn nf_no_goal_exists() {
    use TypeCheckWarningSummary::*;
    let src = include_str!(
        "../../../sample_code/should_succeed/single_file/should_succeed_with_warnings/check/nf_no_goal_exists.k"
    );
    let expected_warnings = vec![
...
fn nf_non_goal_assertion_type_check_failure() {
    use TypeCheckWarningSummary::*;
    let src = include_str!(
        "../../../sample_code/should_succeed/single_file/should_succeed_with_warnings/check/nf_non_goal_assertion_type_check_failure.k"
    );
    let expected_warnings = vec![
...
fn nf_goal_assertion_type_check_failure() {
    use TypeCheckWarningSummary::*;
    let src = include_str!(
        "../../../sample_code/should_succeed/single_file/should_succeed_with_warnings/check/nf_goal_assertion_type_check_failure.k"
    );
    let expected_warnings = vec![
        NormalFormAssertionCompareeTypeCheckFailure {
            reason: TypeCheckFailureReasonSummary::BindError,
...
fn mismatched_nf_comparees() {
    use TypeCheckWarningSummary::*;
    let src =
        include_str!("../../../sample_code/should_succeed/single_file/should_succeed_with_warnings/check/mismatched_nf_comparees.k");
    let expected_warnings = vec![
