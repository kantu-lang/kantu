...
#[test]
fn empty() {
    let src = include_str!("../../../sample_code/should_fail/parse/transparency/empty.ph");
    expect_unexpected_non_eoi_token_error(src, TokenKind::RParen, ")");
}

#[test]
fn super1() {
    let src = include_str!("../../../sample_code/should_fail/parse/transparency/super1.ph");
    expect_unexpected_non_eoi_token_error(src, TokenKind::StandardIdentifier, "super1");
}

#[test]
fn super9() {
    let src = include_str!("../../../sample_code/should_fail/parse/transparency/super9.ph");
