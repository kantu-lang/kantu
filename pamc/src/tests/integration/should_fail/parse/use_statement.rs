...
#[test]
fn dot_dot() {
    let src = include_str!("../../../sample_code/should_fail/parse/use/dot_dot.ph");
    expect_unexpected_non_eoi_token_error(src, TokenKind::Dot, ".");
}

#[test]
fn dot_as() {
    let src = include_str!("../../../sample_code/should_fail/parse/use/dot_as.ph");
    expect_unexpected_non_eoi_token_error(src, TokenKind::As, "as");
}

#[test]
fn dot_semicolon() {
    let src = include_str!("../../../sample_code/should_fail/parse/use/dot_semicolon.ph");
    expect_unexpected_non_eoi_token_error(src, TokenKind::Semicolon, ";");
}

#[test]
fn dotless_star() {
    let src = include_str!("../../../sample_code/should_fail/parse/use/dotless_star.ph");
    expect_unexpected_non_eoi_token_error(src, TokenKind::Star, "*");
}

#[test]
fn dotless_ident() {
    let src = include_str!("../../../sample_code/should_fail/parse/use/dotless_ident.ph");
