...
fn explicit_underscore_label() {
    let src = include_str!("../../../sample_code/should_fail/parse/labeled_call_args/underscore_label/explicit_underscore_label.ph");
    expect_underscore_label_params_error(src, TokenKind::Colon);
}

#[test]
fn implicit_underscore_label() {
    let src = include_str!("../../../sample_code/should_fail/parse/labeled_call_args/underscore_label/implicit_underscore_label.ph");
    expect_underscore_label_params_error(src, TokenKind::Underscore);
}

#[test]
fn second_label_is_underscore() {
    let src = include_str!("../../../sample_code/should_fail/parse/labeled_call_args/underscore_label/second_label_is_underscore.ph");
    expect_underscore_label_params_error(src, TokenKind::Colon);
}
