            ...
            match right_id {
                ExpressionId::Name(right_name_id) => {
                    let right_symbol = state
                        .symbol_db
                        .identifier_symbols
                        .get(state.registry.rightmost_component(right_name_id).id);
        ...
        match left_id.0 {
            ExpressionId::Name(left_name_id) => {
                let left_symbol = state
                    .symbol_db
                    .identifier_symbols
                    .get(state.registry.rightmost_component(left_name_id).id);
                    ...
                    match (left_call.callee_id, right_call.callee_id) {
                        (
                            ...
                            let left_callee_symbol = state
                                .symbol_db
                                .identifier_symbols
                                .get(state.registry.rightmost_component(left_callee_name_id).id);
                            ...
                            let right_callee_symbol = state
                                .symbol_db
                                .identifier_symbols
                                .get(state.registry.rightmost_component(right_callee_name_id).id);
