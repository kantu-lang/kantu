...
#[derive(Clone, Debug)]
pub struct TypeMap {
    raw: FxHashMap<Symbol, NodeId<WrappedExpression>>,
}
...
impl TypeMap {
    pub fn insert_new(&mut self, symbol: Symbol, type_id: NodeId<WrappedExpression>) {
    ...
    pub fn get(&self, symbol: Symbol) -> NodeId<WrappedExpression> {
    ...
    fn try_get(&self, symbol: Symbol) -> Option<NodeId<WrappedExpression>> {
